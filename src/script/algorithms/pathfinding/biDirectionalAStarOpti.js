...
async function biDirectionalAStarOpti(grid, start, end, difficultyMode, diagonal, heuristique){
    ...
    while(openListForward.size > 0 && openListBackward.size > 0){
        ...
        if(bestMeeting !== null && openListForward.peek() + openListBackward.peek() >= bestCost){
